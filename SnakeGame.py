# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
#                        Nitish Singh Chauhan- Bharath University                             #
...
def home(x, y):
    ...
    turtle.color("black")
    turtle.goto(0, 0)
    turtle.write("Play", font=(30))
    turtle.title("Snake Game by Nitish Singh Chauhan")
...
def start(x, y):
    ...
    while x > -210 and x < 210 and y > -210 and y < 210:
        ...
        if x > fcoord[0] * 20 - 5 and x < fcoord[0] * 20 + 5 and y > fcoord[1] * 20 - 5 and y < fcoord[1] * 20 + 5:
            ...
            a[0] += 1
            tscore.clear()
            tscore.write("Score:" + str(a[0]), align="center", font=(18))
...
def gameover():
    ...
    turtle.goto(0, 150)
    turtle.color("red")
    turtle.write("Game Over", align="center", font=(18))
    turtle.goto(0, 50)
    turtle.write("Score:" + str(a[0]), align="center", font=(18))
    turtle.goto(200, -200)
...
# # # # # # # # # # # # # # # # # # # # # #
# Main Run Hyder by Nitish Singh Chauhan  #
# # # # # # # # # # # # # # # # # # # # # #
